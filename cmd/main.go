...
import (
	...
	esv1beta1 "github.com/external-secrets/external-secrets/apis/externalsecrets/v1"
	...
	"github.com/weichen-lin/lumos/internal/apiserver"
	"github.com/weichen-lin/lumos/internal/controller"
...
func main() {
	...
	flag.StringVar(&apiAddr, "api-bind-address", ":8090", "The address the dashboard API and frontend bind to.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "841a616c.lumos.io",
	...
	// Start the dashboard API server alongside the controller manager.
	go func() {
		setupLog.Info("starting dashboard API server", "addr", apiAddr)
		if err := apiserver.New(mgr.GetClient(), apiAddr).Start(ctx); err != nil {
			setupLog.Error(err, "dashboard API server failed")
		}
	}()
